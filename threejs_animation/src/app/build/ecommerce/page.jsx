                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                Shops that sell while you build your brand. Beautiful storefronts
                                that turn window shoppers into loyal buyers. Seamless navigation,
                                secure payments, and experiences that make checkout feel effortless.
                                Built for performance, scale, and repeat business, not just pretty
                                pictures.
                            </p>
                        </div>
                    </div>
