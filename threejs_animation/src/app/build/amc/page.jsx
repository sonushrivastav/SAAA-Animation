                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                Because great websites never get to retire. Fresh updates, quick
                                fixes, and care that keeps your site young. Regular tune-ups that
                                prevent downtime and preserve performance. Behind every strong site
                                is a team that never stops watching its back.
                            </p>
                        </div>
                    </div>
