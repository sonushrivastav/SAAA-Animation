                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                The heavy lifters of the digital world. Smart features wrapped in
                                beautiful interfaces. Built for function, speed, and seamless
                                integration into your business. From dashboards to portals, every
                                click feels smooth, intuitive, and intentional.
                            </p>
                        </div>
                    </div>
