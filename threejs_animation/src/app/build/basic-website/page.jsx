                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                A home for your brand that’s as sleek as it is simple. Clean
                                layouts, smart flow, and instant charm. Designed to load fast, look
                                stunning, and tell your story from the first scroll. Every element
                                is built for clarity so visitors find what they need before they
                                even have to ask.
                            </p>
                        </div>
                    </div>
