                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                A control room for your creativity. Update anything, anytime, and
                                keep it perfectly on-brand. Designed to give you freedom without the
                                technical fuss. Because real control is about spending time
                                creating, not fixing what should already work.
                            </p>
                        </div>
                    </div>
