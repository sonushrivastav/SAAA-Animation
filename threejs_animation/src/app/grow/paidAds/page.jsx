                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                We make algorithms your allies. Every click is tracked, every rupee
                                earns its keep, every ad works harder than the last. Strategy and
                                creativity come together to deliver measurable results. From
                                awareness to action, we make every impression count.
                            </p>
                        </div>
                    </div>
