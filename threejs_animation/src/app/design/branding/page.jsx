                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                Recognition that goes beyond the logo. A tone, a mood, a look that
                                people associate with you instantly. Every brand touchpoint feels
                                intentional, designed to create familiarity at first glance. The
                                kind of branding that feels effortless because it’s built on depth,
                                not decoration.
                            </p>
                        </div>
                    </div>
