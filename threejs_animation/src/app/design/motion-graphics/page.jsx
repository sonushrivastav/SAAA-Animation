                    ...
                    <div className="z-10 relative w-full md:w-[65%] self-stretch flex items-center    text-[#0f0f0f] ">
                        <div className="px-8 py-10 md:px-14 lg:px-28 md:py-16 lg:py-20 ">
                            ...
                            <p className="text-[#555555] mt-6 max-w-lg mx-auto md:mx-0 md:text-xl">
                                Stories that move in every sense. The rhythm, the energy, and the
                                kind of flow that keeps eyes glued. Every frame is edited to make
                                your message impossible to skip. With every transition and beat,
                                your story finds its rhythm and your brand finds its voice.
                            </p>
                        </div>
                    </div>
