...
import { memo, Suspense, useLayoutEffect, useRef, useState } from "react";
...
// Dynamic import DotGrid - heavy component with canvas animations
const DotGrid = dynamic(
  () => import("../../components/allServicesComponents/DotGrid"),
  {
    ssr: false,
    loading: () => (
      <div className="w-full h-full bg-[#271e37]/20 animate-pulse" />
    ),
  }
);
...
// Quote SVG as separate component to avoid recreation
const QuoteSvg = memo(function QuoteSvg() {
  return (
    <svg
      width="43"
      height="31"
...
const VisionCard = memo(function VisionCard({ item, index }) {
  return (
...
const About = () => {
  ...
  useLayoutEffect(() => {
    // Defer GSAP setup to after paint
