...
// export default function StarfieldBackground({ activeIndex = 0 }) {
...
//         color.set('#844de9'); // 👈 change this hex value to your desired color
...
//                 // 🟢 CORRECTED DISPLACEMENT LOGIC
//                 float force = (uRepulseRadius - dist) / uRepulseRadius;
//                 force = pow(force, 2.0);

//                 // Apply X and Y strengths separately
//                 pos.x += repulseDir.x * force * uRepulseStrength.x ;
//                 pos.y += repulseDir.y * force * uRepulseStrength.y;

//                 // Optional: Average them for Z
...
//           float shapeBaseSize = 0.11; // Adjust this number to make shape points smaller/larger
...
//         // Define your hardcoded strengths here
//         const strengthX = 0.8; // Horizontal push
//         const strengthY = 0.1; // Vertical push (weaker)
...
//             material.uniforms.uRepulseStrength.value.set(strengthX, strengthY);
//         } else {
//             // ⛔ Force to 0 for Mobile/Tablet
//             material.uniforms.uRepulseStrength.value.set(0, 0);
//         }
...
//         };
//     }, [controls, starData, isMobile, isDesktop]); // added isMobile to dependency
